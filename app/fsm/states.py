...
class ConversationState(str, Enum):
    ...
    WAITING_FOR_ANNIVERSARY = "WAITING_FOR_ANNIVERSARY"
    ...
    WAITING_FOR_RITUAL_OPENING = "WAITING_FOR_RITUAL_OPENING"  # Stage 0: Breathing/Atmosphere
    WEEKLY_PROMPT_SENT = "WEEKLY_PROMPT_SENT"
    WAITING_FOR_CATEGORY = "WAITING_FOR_CATEGORY"
    WAITING_FOR_CHINTA_REFLECTION = "WAITING_FOR_CHINTA_REFLECTION"  # Stage 1: Validation
    WAITING_FOR_SANKALP_AGREEMENT = "WAITING_FOR_SANKALP_AGREEMENT"  # Stage 2: Cosmic Sankalp Agreement
    WAITING_FOR_TYAGAM_DECISION = "WAITING_FOR_TYAGAM_DECISION"  # Temple-style: optional Tyagam
    WAITING_FOR_TIER = "WAITING_FOR_TIER"
    WAITING_FOR_FREQUENCY = "WAITING_FOR_FREQUENCY"  # Monthly vs One-time choice
